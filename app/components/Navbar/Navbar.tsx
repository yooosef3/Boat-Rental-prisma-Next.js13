...
const Navbar = () => {
  return (
      <div className="flex fixed top-0 inset-x-0 z-30 justify-between items-center text-white font-semibold p-5 px-10 lg:px-20 xl:px-32 bg-[#282D33] lg:bg-opacity-0">
        <MobileUser />
        <Enter />
        <Logo />
        <MenuLinks />
