...
import boat from "../../../public/images/header_overview.jpeg";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-7 lg:gap-10 items-center lg:items-start justify-center text-white mt-16 absolute inset-0 px-10 lg:px-20 xl:px-32">
        <h1 className="font-bold text-3xl lg:text-5xl xl:text-6xl">
          سفری هیجان انگیز
        </h1>
        <p className="text-center lg:text-right max-w-2xl lg:text-lg font-semibold leading-7">
